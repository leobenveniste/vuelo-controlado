...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="text-slate-400 pt-24 pb-12 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-20">
          <div className="space-y-8">
            <div className="flex items-center">
              <div className="h-12">
                <img src="/logo_blanco.png?v=1" alt="Logo" className="h-full w-auto object-contain" />
              </div>
            </div>
            <div className="flex flex-col space-y-4">
              <a 
                ...
                className="flex items-center space-x-3 text-slate-400 hover:text-primary-500 transition-colors group"
              >
                <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center group-hover:bg-primary-500/10 transition-all border border-white/5">
          ...
          <div>
            <h4 className="text-white font-black uppercase tracking-widest text-xs mb-8">{t('footer.nav')}</h4>
          ...
          <div>
            <h4 className="text-white font-black uppercase tracking-widest text-xs mb-8">{t('footer.contact')}</h4>
        ...
        <div className="border-t border-white/5 pt-12 flex flex-col md:flex-row justify-between items-center text-xs font-bold uppercase tracking-[0.2em] text-slate-600">
