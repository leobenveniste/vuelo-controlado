    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-display font-black text-white mb-6 tracking-tighter">{t('mission.title')}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {cards.map((card, index) => (
            <motion.div
              ...
              className="p-10 rounded-[2.5rem] border border-white/5 bg-white/5 hover:bg-white/10 hover:border-primary-500/20 transition-all duration-500 group text-center"
            >
              ...
              <h3 className="text-2xl font-black text-white mb-4 tracking-tight leading-tight">{card.title}</h3>
