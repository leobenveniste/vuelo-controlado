      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-20 mb-32">
          ...
          >
            ...
            <div className="relative z-10 rounded-[3rem] overflow-hidden border border-slate-200 dark:border-slate-800 shadow-2xl shadow-primary-500/10 aspect-square">
              <img 
                src="/nosotros.jpg" 
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-10">
              <div>
                <p className="text-5xl font-display font-black text-slate-900 dark:text-white mb-2 tracking-tighter">100%</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          {[
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-1 tracking-tight">{member.name}</h3>
