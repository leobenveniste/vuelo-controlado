...
const MissionPage: React.FC = () => {
  ...
  return (
    <div className="pt-32 pb-24 text-slate-100">
      {/* Vision Statement */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-slate-400 leading-relaxed italic border-l-4 border-primary-500 pl-6">
              "{t('mission.vision.quote')}"
            </p>
          </div>
          <div className="lg:w-1/2 grid grid-cols-2 gap-4">
            <div className="space-y-4">
              <div className="aspect-square bg-slate-900 rounded-3xl flex flex-col items-center justify-center p-8 border border-slate-800">
            ...
            <div className="space-y-4 pt-8">
              <div className="p-8 bg-slate-800 text-white rounded-3xl border border-slate-700">
              ...
              <div className="aspect-square bg-slate-900 rounded-3xl flex flex-col items-center justify-center p-8 border border-slate-800">
                ...
                <p className="text-center font-bold">{t('mission.stats.reduction')}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900/50 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-3xl font-display font-bold text-white">{t('mission.pillars.title')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {values.map((value, i) => (
              <motion.div 
                ...
                className="text-center space-y-6 bg-slate-900 p-10 rounded-[2.5rem] border border-slate-800 hover:border-primary-500/50 transition-colors"
              >
                <div className="inline-flex items-center justify-center w-20 h-20 bg-slate-800 rounded-2xl mb-2">
                  {value.icon}
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="bg-gradient-to-br from-slate-900 to-[#0A0A0A] rounded-[3rem] p-12 md:p-20 text-white border border-slate-800 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            <div className="aspect-video bg-slate-800 rounded-2xl flex items-center justify-center border border-slate-700 overflow-hidden relative p-12">
               <div className="absolute inset-0 bg-primary-500/5 animate-pulse" />
               <img src="/logo_blanco.png?v=1" alt="Logo" className="w-full h-full object-contain relative z-10 opacity-30 group-hover:opacity-100 transition-all duration-500" />
            </div>
          </div>
        </div>
      </section>
